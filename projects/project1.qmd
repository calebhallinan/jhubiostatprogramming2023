...
Caleb Note: I already have a website that uses quarto, so you can find the github repo for it here: https://github.com/calebhallinan/calebhallinan.github.io
...
# 1. use wget
wget https://github.com/stephaniehicks/jhustatprogramming2023/tree/main/data/SRR1039508_subset_1.fastq
wget https://github.com/stephaniehicks/jhustatprogramming2023/tree/main/data/SRR1039509_subset_1.fastq
wget https://github.com/stephaniehicks/jhustatprogramming2023/tree/main/data/SRR1039512_subset_1.fastq
wget https://github.com/stephaniehicks/jhustatprogramming2023/tree/main/data/SRR1039513_subset_1.fastq
...
grep -A 4 -B 2 NNNN SRR1039512_subset_1.fastq
...
Questions
1. step 4 - use the name of the file? cause non of them end in 12/13
